...
<template>  
  ...
  <header class="header-newsroom">
   ...
   <nav class="navbar navbar-expand-lg navbar-light font-regular navbar-inverse">
      <div class="px-4 container">

      <a class="navbar-brand" id="nav-homepage" href="/">
        <div class="my-3 mx-1">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto my-3 mb-lg-0">
        </ul>
      </div>
      </div>
    </nav>
  ...
  <article class="article">
    <div class="article-header">
      <div class="category component">
        <div class="component-content">
            <div class="category-eyebrow">
                <h3 class="subtitle category_release">{{ newsRoom[0].type }}</h3>
                <span class="category-eyebrow__date">{{ newsRoom[0].date }}</span>
            </div>
        </div>
      </div>
      ...
      <div class="pagetitle component">
        <div class="component-content">
          <h1 class="mb-4">{{ newsRoom[0].title }}</h1>
        </div>
      </div>
    ...
    <div class="pagebody text component">
      <div class="component-content" v-for="(p, i) in newsRoom[0].body ">
